...
from apps.permissions.constants import ORG_MEMBER_GROUP_NAME, ORG_ADMIN_GROUP_NAME
    ...
    for group in Group.objects.exclude(responsiblegroup=None):
        ...
        try:
            ...
            if organization.member_group == responsible_group:
                responsible_group_name = ORG_MEMBER_GROUP_NAME
            elif organization.admin_group == responsible_group:
                responsible_group_name = ORG_ADMIN_GROUP_NAME
