    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "permissions": [
                    (
                        "manage_nfc",
                        "Can manage NFC cards, assignments, and access grants",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "constraints": [
                    ...
                    models.UniqueConstraint(
                        condition=models.Q(
                            ("revoked_at__isnull", True), ("user__isnull", False)
                        ),
                        fields=("user",),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["occurred_at"], name="nfc_nfc_acc_occurre_65ac6b_idx"
                    ),
                    models.Index(
