# Generated by Django 3.2.22 on 2024-04-04 14:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.IntegerField(choices=[(1, 'Cabin'), (2, 'Car')])),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('booking_products', models.ManyToManyField(related_name='bookings', to='booking.Product')),
            ],
            options={
