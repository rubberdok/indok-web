      ...
      <Stack direction="row" justifyContent="space-between">
        <Stack direction="column">
          ...
          <Typography variant="caption">
            Her er det mulig å spesifisere antall plasser for forskjellige grupper. Dersom det er like mange påmeldte
            som det er plasser totalt på arrangementet så vil arrangementet være fullt, selv om det skulle være ledige
            plasser i enkelte grupper, og motsatt: dersom alle gruppene er fulle så vil arrangementet være fullt selv om
            det er ledige plasser totalt.
          </Typography>
        </Stack>
      </Stack>
      <Stack direction="column" spacing={2}>
...
export { SignUpForm, signUpEventValidationSchema };
