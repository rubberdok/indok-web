...
export type LogTicTacToeMutationVariables = Exact<{
  winner?: InputMaybe<Scalars['String']['input']>;
}>;


export type LogTicTacToeMutation = { __typename?: 'Mutations', logTicTacToe?: { __typename?: 'LogTicTacToeMutation', ok?: boolean | null } | null };

export type GetWinnersListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetWinnersListQuery = { __typename?: 'Queries', getWinnersList?: Array<{ __typename?: 'ticTacToeType', gameResult: string } | null> | null };
...
export const LogTicTacToeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"logTicTacToe"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"winner"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logTicTacToe"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"winner"},"value":{"kind":"Variable","name":{"kind":"Name","value":"winner"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ok"}}]}}]}}]} as unknown as DocumentNode<LogTicTacToeMutation, LogTicTacToeMutationVariables>;
export const GetWinnersListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getWinnersList"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getWinnersList"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"gameResult"}}]}}]}}]} as unknown as DocumentNode<GetWinnersListQuery, GetWinnersListQueryVariables>;
