...
export type ProductsQuery = { __typename?: 'Queries', products?: Array<{ __typename?: 'ProductType', id: string, name: string, description: string, price: number, maxBuyableQuantity: number, shopItem: boolean }> | null };
...
export type SignUpWithTicketFragment = { __typename?: 'SignUpType', hasBoughtTicket?: boolean | null, userEmail: string, userGradeYear: number, userAllergies?: string | null, userPhoneNumber: string, extraInformation: string, user: { __typename?: 'UserType', id: string, firstName: string, lastName: string } };
