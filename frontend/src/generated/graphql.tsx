...
export type DeliveredProductMutation = { __typename?: 'Mutations', attemptCapturePayment?: { __typename?: 'AttemptCapturePayment', order?: { __typename?: 'OrderType', id: string, quantity: number, totalPrice: number, paymentStatus: PaymentStatus, timestamp: string, deliveredProduct: boolean, product: { __typename?: 'ProductType', id: string, name: string, description: string, price: number, maxBuyableQuantity: number, shopItem: boolean }, user: { __typename?: 'UserType', id: string, username: string, firstName: string, lastName: string } } | null } | null };
