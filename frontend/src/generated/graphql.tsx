...
export type AdminUserNfcInput = {
  mifareCsn?: string | null | undefined;
...
export type CreateNfcAccessGrantInput = {
  ...
  grantedToMifareCsn?: string | null | undefined;
...
export type LogNfcAccessEventInput = {
  ...
  eventType: string;
  mifareCsnReported?: string | null | undefined;
  notes?: string | null | undefined;
  rawPayload?: unknown;
...
export type UserInput = {
  ...
  graduationYear?: number | null | undefined;
  lastName?: string | null | undefined;
  nfcMifareCsn?: string | null | undefined;
...
export type NfcCardLiteFragment = { id: string, mifareCsn: string, label: string, isEnabled: boolean };

export type NfcCardAssignmentFragment = { id: string, externalHolderName: string, assignedAt: string, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, revocationReason: string, hasAccessNow: boolean | null, metadata: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean }, user: { id: string, username: string, firstName: string, lastName: string } | null, assignedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null };

export type NfcCardFragment = { id: string, mifareCsn: string, label: string, notes: string, isEnabled: boolean, createdAt: string, updatedAt: string, activeAssignment: { id: string, externalHolderName: string, assignedAt: string, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, revocationReason: string, hasAccessNow: boolean | null, metadata: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean }, user: { id: string, username: string, firstName: string, lastName: string } | null, assignedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null } | null };

export type NfcAccessGrantFragment = { id: string, scope: NfcNfcAccessGrantScopeChoices, participantPolicy: NfcNfcAccessGrantParticipantPolicyChoices, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, notes: string, hasAccessNow: boolean | null, createdAt: string, updatedAt: string, booking: { id: string, checkIn: string, checkOut: string } | null, grantedToUser: { id: string, username: string, firstName: string, lastName: string } | null, grantedToCard: { id: string, mifareCsn: string, label: string, isEnabled: boolean } | null, grantedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null };

export type NfcAccessEventFragment = { id: string, eventType: NfcNfcAccessEventEventTypeChoices, source: NfcNfcAccessEventSourceChoices, doorIdentifier: string, mifareCsnReported: string, occurredAt: string, notes: string, rawPayload: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean } | null, cardAssignment: { id: string, externalHolderName: string, permanentAccess: boolean, accessStart: string | null, accessEnd: string | null, revokedAt: string | null } | null, resolvedUser: { id: string, username: string, firstName: string, lastName: string } | null };
...
export type UpsertNfcCardMutation = { upsertNfcCard: { ok: boolean, card: { id: string, mifareCsn: string, label: string, notes: string, isEnabled: boolean, createdAt: string, updatedAt: string, activeAssignment: { id: string, externalHolderName: string, assignedAt: string, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, revocationReason: string, hasAccessNow: boolean | null, metadata: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean }, user: { id: string, username: string, firstName: string, lastName: string } | null, assignedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null } | null } | null } | null };
...
export type AssignNfcCardMutation = { assignNfcCard: { ok: boolean, assignment: { id: string, externalHolderName: string, assignedAt: string, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, revocationReason: string, hasAccessNow: boolean | null, metadata: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean }, user: { id: string, username: string, firstName: string, lastName: string } | null, assignedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null } | null } | null };
...
export type CreateNfcAccessGrantMutation = { createNfcAccessGrant: { ok: boolean, accessGrant: { id: string, scope: NfcNfcAccessGrantScopeChoices, participantPolicy: NfcNfcAccessGrantParticipantPolicyChoices, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, notes: string, hasAccessNow: boolean | null, createdAt: string, updatedAt: string, booking: { id: string, checkIn: string, checkOut: string } | null, grantedToUser: { id: string, username: string, firstName: string, lastName: string } | null, grantedToCard: { id: string, mifareCsn: string, label: string, isEnabled: boolean } | null, grantedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null } | null } | null };
...
export type LogNfcAccessEventMutation = { logNfcAccessEvent: { ok: boolean, event: { id: string, eventType: NfcNfcAccessEventEventTypeChoices, source: NfcNfcAccessEventSourceChoices, doorIdentifier: string, mifareCsnReported: string, occurredAt: string, notes: string, rawPayload: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean } | null, cardAssignment: { id: string, externalHolderName: string, permanentAccess: boolean, accessStart: string | null, accessEnd: string | null, revokedAt: string | null } | null, resolvedUser: { id: string, username: string, firstName: string, lastName: string } | null } | null } | null };

export type NfcCardsQueryVariables = Exact<{ [key: string]: never; }>;


export type NfcCardsQuery = { nfcCards: Array<{ id: string, mifareCsn: string, label: string, notes: string, isEnabled: boolean, createdAt: string, updatedAt: string, activeAssignment: { id: string, externalHolderName: string, assignedAt: string, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, revocationReason: string, hasAccessNow: boolean | null, metadata: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean }, user: { id: string, username: string, firstName: string, lastName: string } | null, assignedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null } | null }> | null };
...
export type NfcCardQuery = { nfcCard: { id: string, mifareCsn: string, label: string, notes: string, isEnabled: boolean, createdAt: string, updatedAt: string, activeAssignment: { id: string, externalHolderName: string, assignedAt: string, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, revocationReason: string, hasAccessNow: boolean | null, metadata: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean }, user: { id: string, username: string, firstName: string, lastName: string } | null, assignedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null } | null } | null };
...
export type NfcAccessGrantsQuery = { nfcAccessGrants: Array<{ id: string, scope: NfcNfcAccessGrantScopeChoices, participantPolicy: NfcNfcAccessGrantParticipantPolicyChoices, accessStart: string | null, accessEnd: string | null, permanentAccess: boolean, revokedAt: string | null, notes: string, hasAccessNow: boolean | null, createdAt: string, updatedAt: string, booking: { id: string, checkIn: string, checkOut: string } | null, grantedToUser: { id: string, username: string, firstName: string, lastName: string } | null, grantedToCard: { id: string, mifareCsn: string, label: string, isEnabled: boolean } | null, grantedBy: { id: string, username: string, firstName: string, lastName: string } | null, revokedBy: { id: string, username: string, firstName: string, lastName: string } | null }> | null };
...
export type NfcAccessEventsQuery = { nfcAccessEvents: Array<{ id: string, eventType: NfcNfcAccessEventEventTypeChoices, source: NfcNfcAccessEventSourceChoices, doorIdentifier: string, mifareCsnReported: string, occurredAt: string, notes: string, rawPayload: unknown, card: { id: string, mifareCsn: string, label: string, isEnabled: boolean } | null, cardAssignment: { id: string, externalHolderName: string, permanentAccess: boolean, accessStart: string | null, accessEnd: string | null, revokedAt: string | null } | null, resolvedUser: { id: string, username: string, firstName: string, lastName: string } | null }> | null };
...
export type UserToEditFragment = { id: string, username: string, firstName: string, lastName: string, phoneNumber: string, allergies: string | null, email: string, graduationYear: number | null, firstLogin: boolean, feideEmail: string, canUpdateYear: boolean | null, yearUpdatedAt: string | null, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null };

export type UserAdminEditFragment = { feideUserid: string, gradeYear: number | null, dateJoined: string, lastLogin: string | null, id: string, username: string, firstName: string, lastName: string, phoneNumber: string, allergies: string | null, email: string, graduationYear: number | null, firstLogin: boolean, feideEmail: string, canUpdateYear: boolean | null, yearUpdatedAt: string | null, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null };

export type UserNfcSearchFragment = { id: string, username: string, firstName: string, lastName: string, feideEmail: string, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null };

export type UserAdminSearchFragment = { email: string, phoneNumber: string, allergies: string | null, graduationYear: number | null, gradeYear: number | null, dateJoined: string, lastLogin: string | null, feideUserid: string, id: string, username: string, firstName: string, lastName: string, feideEmail: string, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null };
...
export type AdminUpdateUserMutation = { adminUpdateUser: { user: { feideUserid: string, gradeYear: number | null, dateJoined: string, lastLogin: string | null, id: string, username: string, firstName: string, lastName: string, phoneNumber: string, allergies: string | null, email: string, graduationYear: number | null, firstLogin: boolean, feideEmail: string, canUpdateYear: boolean | null, yearUpdatedAt: string | null, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null } | null } | null };
...
export type AdminUpdateUserNfcMutation = { adminUpdateUserNfc: { user: { feideUserid: string, gradeYear: number | null, dateJoined: string, lastLogin: string | null, id: string, username: string, firstName: string, lastName: string, phoneNumber: string, allergies: string | null, email: string, graduationYear: number | null, firstLogin: boolean, feideEmail: string, canUpdateYear: boolean | null, yearUpdatedAt: string | null, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null } | null } | null };
...
export type UserToEditQuery = { user: { id: string, username: string, firstName: string, lastName: string, phoneNumber: string, allergies: string | null, email: string, graduationYear: number | null, firstLogin: boolean, feideEmail: string, canUpdateYear: boolean | null, yearUpdatedAt: string | null, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null } | null };
...
export type NfcUserSearchQuery = { nfcUserSearch: Array<{ id: string, username: string, firstName: string, lastName: string, feideEmail: string, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null }> | null };
...
export type UserSearchQuery = { userSearch: Array<{ email: string, phoneNumber: string, allergies: string | null, graduationYear: number | null, gradeYear: number | null, dateJoined: string, lastLogin: string | null, feideUserid: string, id: string, username: string, firstName: string, lastName: string, feideEmail: string, nfcMifareCsn: string | null, nfcPinCode: string | null, nfcPermanentAccess: boolean | null }> | null };
