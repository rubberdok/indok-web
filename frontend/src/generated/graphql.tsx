...
export type AllBlogPostsQuery = { __typename?: 'Queries', allBlogPosts?: Array<{ __typename?: 'BlogPostType', id: string, title: string, text: string, publishDate: string, author?: { __typename?: 'UserType', firstName: string, lastName: string } | null }> | null };
