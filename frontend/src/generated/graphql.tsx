...
export type UserSearchQuery = { __typename?: 'Queries', userSearch?: Array<{ __typename?: 'UserType', id: string, username: string, firstName: string, lastName: string, email: string, phoneNumber: string, allergies?: string | null, graduationYear?: number | null, gradeYear?: number | null, dateJoined: string, lastLogin?: string | null, feideUserid: string, feideEmail: string, nfcUidHex?: string | null, nfcPinCode?: string | null, nfcPermanentAccess?: boolean | null }> | null };
