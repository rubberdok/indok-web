...
export const shadows: CssVarsThemeOptions["shadows"] = [
  ...
  `0px 6px 7px -4px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 11px 08px 1px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 4px 20px 3px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
  ...
  `0px 7px 8px -4px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 04px 10px 2px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 5px 24px 4px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
  ...
  `0px 8px 9px -5px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 08px 22px 2px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 6px 28px 5px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
  ...
  `0px 9px 12px -6px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 10px 29px 2px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 7px 36px 6px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
  `0px 10px 04px -6px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 20px 31px 3px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 8px 38px 7px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
  `0px 10px 04px -6px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 21px 33px 3px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 8px 40px 7px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
  ...
  `0px 11px 08px -7px rgba(var(--mui-palette-shadowChannel) / 0.10),0px 24px 38px 3px rgba(var(--mui-palette-shadowChannel) / 0.08),0px 9px 46px 8px rgba(var(--mui-palette-shadowChannel) / 0.04)`,
];
