...
export const cabinInfoValidationSchema = Yup.object().shape({
  oksenInternalPrice: Yup.number()
    .typeError("Må være et tall.")
    .min(1, "Prisen må være større enn 0."),
  bjornenInternalPrice: Yup.number()
    .typeError("Må være et tall.")
    .min(1, "Prisen må være større enn 0."),
  oksenExternalPrice: Yup.number()
    .notRequired()
    .typeError("Må være et tall.")
    .min(1, "Prisen må være større enn 0."),
  bjornenExternalPrice: Yup.number()
    .notRequired()
    .typeError("Må være et tall.")
    .min(1, "Prisen må være større enn 0."),
