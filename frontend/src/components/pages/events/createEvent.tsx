...
import { EventCategoryFragment, useAllEventCategoriesQuery } from "src/api/generated/graphql";
        ...
        <Grid item xs={6}>
          <FormControl>
            ...
            >
              ...
              {categoryData?.allCategories?.map((category: EventCategoryFragment | null) => (
