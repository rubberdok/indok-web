  ...
  return (
    <Dialog onClose={onClose} aria-labelledby="sales-terms-dialog-title" open={open} scroll="paper">
      ...
      <DialogContent dividers>
        <div>
          <h1>Standard salgsbetingelser for forbrukerkjøp av varer over Internett</h1>
          <article id="post-2179" role="article">
            <header>
              <div id="ingress"></div>
            </header>
            ...
            <section id="chapter-0">
              ...
              <div>
                <p>
                  ...
                  Vilkårene i denne avtalen skal ikke forstås som noen begrensning i de lovbestemte
                ...
                <p>
                  ...
                  >
                    For en bedre forståelse av disse salgsbetingelsene, se Forbrukertilsynets
                    veileder her.{" "}
                  </a>
                </p>
              </div>
            ...
            <section id="chapter-1">
              ...
              <div>
                <p>
                  ...
                  mellom opplysningene, går det som særskilt er avtalt mellom partene foran, så
                  fremt det ikke strider mot ufravikelig lovgivning.
                </p>
                <p>
            ...
            <section id="chapter-2">
              ...
              <div>
                <p>
                  Selger er Foreningen for Studentene ved Industriell Økonomi og Teknologiledelse,
                  NTNU, Kolbjørn Hejes vei 1E, 7034 Trondheim, leder@indokhs.no, Org.nr. 994 778
                  463, og betegnes i det følgende som &nbsp;selger/selgeren.
                </p>
                <p>
            ...
            <section id="chapter-4">
              ...
              <div>
                ...
                <p>
                  ...
                  bestilling, og den annen part innså eller burde ha innsett at det forelå en slik
                  feil.
                </p>
              </div>
            </section>
            <section id="chapter-5">
              ...
              <div>
                ...
                <p>
                  ...
                  varen. Betalingsfristen fremgår av fakturaen og er på minimum 14 dager fra mottak.
                </p>
            ...
            <section id="chapter-6">
              ...
              <div>
                ...
                <p>
                  ...
                  kunden. Varen skal leveres hos kjøperen med mindre annet er særskilt avtalt mellom
                  partene.
                </p>
              </div>
            </section>
            ...
            <section id="chapter-8">
              ...
              <div>
                ...
                <p>
                  ...
                  begynner å løpe. I fristen inkluderes alle kalenderdager. Dersom fristen ender på
                  en lørdag, helligdag eller høytidsdag forlenges fristen til nærmeste virkedag.
                </p>
                <p>
                  ...
                  bør derfor skje skriftlig (angrerettskjema, e-post eller brev).
                </p>
                <p>Angrefristen begynner å løpe:</p>
                <ul>
                  <li>
                    Ved kjøp av enkeltstående varer vil angrefristen løpe fra dagen etter varen(e)
                    er mottatt.
                  </li>
                  <li>
                ...
                <p>
                  ...
                  dersom selger ikke før avtaleinngåelsen opplyser om at det foreligger angrerett og
                  standardisert angreskjema. Tilsvarende gjelder ved manglende opplysning om vilkår,
                  tidsfrister og fremgangsmåte for å benytte angreretten. Sørger den næringsdrivende
                  for å gi opplysningene i løpet av disse 12 månedene, utløper angrefristen likevel
                  14 dager etter den dagen kjøperen mottok opplysningene.
                </p>
                <p>
                  Ved bruk av angreretten må varen leveres tilbake til selgeren uten unødig opphold
                  og senest 14 dager fra melding om bruk av angreretten er gitt. Kjøper dekker de
                  direkte kostnadene ved å returnere varen, med mindre annet er avtalt eller selger
                  har unnlatt å opplyse om at kjøper skal dekke returkostnadene. Selgeren kan ikke
                  fastsette gebyr for kjøperens bruk av angreretten.
                </p>
                <p>
                  Kjøper kan prøve eller teste varen på en forsvarlig måte for å fastslå varens art,
                  egenskaper og funksjon, uten at angreretten faller bort. Dersom prøving eller test
                  av varen går utover hva som er forsvarlig og nødvendig, kan kjøperen bli ansvarlig
                ...
                <p>
                  ...
                  mottatt varene fra kjøperen, eller til kjøper har lagt frem dokumentasjon for at
            ...
            <section id="chapter-9">
              <h2>
                9. Forsinkelse og manglende levering - kjøpernes rettigheter og frist for å melde
                krav
              </h2>
              ...
              <div>
                <p>
                  ...
                  avtalen mellom partene, og dette ikke skyldes kjøperen eller forhold på kjøperens
                  side, kan kjøperen i henhold til reglene i forbrukerkjøpslovens kapittel 5 etter
                  omstendighetene <em>holde kjøpesummen tilbake</em>, kreve <em>oppfyl</em>
                  <em>lelse</em>, <em>heve </em>avtalen og/eller kreve <em>erstatning </em>fra
                  selgeren.
                </p>
                <p>
                ...
                <p>
                  ...
                  selgeren oppfyller. Skulle vanskene falle bort innen rimelig tid, kan kjøper
                ...
                <p>
                  ...
                  Tilsvarende gjelder dersom levering til avtalt tid var avgjørende for inngåelsen
                  av avtalen, eller dersom kjøperen har underrettet selger om at
                ...
                <p>
                  ...
                  gjelder imidlertid ikke dersom selgeren godtgjør at forsinkelsen skyldes hindring
            ...
            <section id="chapter-10">
              ...
              <div>
                <p>
                  ...
                  innen 2 mnd. fra mangelen ble oppdaget eller burde blitt oppdaget. Reklamasjon kan
                  skje senest to år etter at kjøper overtok varen. Dersom varen eller deler av den
                  er ment å vare vesentlig lenger enn to år, er reklamasjonsfristen fem år.
                </p>
                <p>
                  Dersom varen har en mangel og dette ikke skyldes kjøperen eller forhold på
                  kjøperens side, kan kjøperen i henhold til reglene i forbrukerkjøpsloven kapittel
                  6 etter omstendighetene <em>holde kjøpesummen tilbake</em>, velge mellom{" "}
                  <em>retting </em>og <em>omlevering</em>, kreve <em>prisavslag</em>, kreve avtalen
                  hevet og/eller kreve <em>erstatning&nbsp; </em>fra selgeren.
                </p>
                <p>Reklamasjon til selgeren bør skje skriftlig.</p>
                <h3>Retting eller omlevering</h3>
                <p>
                  Kjøperen kan velge mellom å kreve mangelen rettet eller levering av tilsvarende
                  ting. Selger kan likevel motsette seg kjøperens krav dersom gjennomføringen av
                  kravet er umulig eller volder selgeren urimelige kostnader. Retting eller
                  omlevering skal foretas innen rimelig tid. Selger har i utgangspunktet ikke rett
            ...
            <section id="chapter-11">
              ...
              <div>
                <p>
                  ...
                  omstendighetene <em>holde</em> <em>varen tilbake</em>, kreve <em>oppfyllelse </em>
                  av avtalen, kreve avtalen <em>hevet </em>samt kreve <em>erstatning </em>fra
                  kjøperen. Selgeren vil også etter omstendighetene kunne kreve{" "}
                ...
                <p>
                  ...
                  ikke levert, taper selgeren sin rett dersom han venter urimelig lenge med å fremme
                  kravet.
                </p>
                <h3>Heving</h3>
                <p>
                  Selger kan heve avtalen dersom det foreligger vesentlig betalingsmislighold eller
                  annet vesentlig mislighold fra kjøperens side. Selger kan likevel ikke heve dersom
                  hele kjøpesummen er betalt. Fastsetter selger en rimelig tilleggsfrist for
                  oppfyllelse og kjøperen ikke betaler innen denne fristen, kan selger heve kjøpet.
                </p>
                ...
                <p>
                  ...
                  kravet, etter forutgående varsel, bli sendt til Kjøper kan da bli holdt ansvarlig
                ...
                <p>
                  ...
                  gebyr. Gebyret skal maksimalt dekke selgerens faktiske &nbsp;utlegg for å levere
                  varen til kjøperen. Et slikt gebyr kan ikke belastes kjøpere under 18 &nbsp;år.
                </p>
              </div>
            </section>
            ...
            <section id="chapter-13">
              ...
              <div>
                <p>
                  ...
                  kunne gjennomføre forpliktelsene etter avtalen. Kjøperens personopplysninger vil
                  kun bli utlevert til andre hvis det er nødvendig for at selger skal få gjennomført
            ...
            <section id="chapter-14">
              ...
              <div>
                <p>
                  ...
                  forsøke å løse eventuelle tvister i minnelighet. Dersom dette ikke lykkes, kan
                  kjøperen ta kontakt med Forbrukerrådet for mekling. Forbrukerrådet er tilgjengelig
                  &nbsp;på &nbsp;telefon 23&nbsp; 400&nbsp; 500&nbsp; eller{" "}
                ...
                <p>
                  ...
                  Det er særlig relevant, hvis du er forbruker bosatt i et annet EU-land. Klagen
                  inngis her:&nbsp;
