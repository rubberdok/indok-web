        ...
        <Grid container justifyContent="space-between" alignItems="center" spacing={{ xs: 2, md: 10 }}>
          ...
          >
            ...
            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              ...
              tilnærmet lik et vanlig bolighus. 
            </Typography>
            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              Begge hyttene har innlagt strøm og vann. I første etasje
              ...
              totalt fjorten sengeplasser på hver hytte og ekstramadrasser til de resterende fire. Dyner og
              puter til 18 gjester ligger tilgjengelig, men laken og sengetøy må medbringes.
            </Typography>
            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              Kjøkkenet er
