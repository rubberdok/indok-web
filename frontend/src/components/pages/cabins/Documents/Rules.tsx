  ...
  return (
    <>
      <Container>
        ...
        <h3 className={classes.ruleHeader}>Nøkkelansvarlig</h3>
        ...
        <Divider />
        <h3 className={classes.ruleHeader}>Bruksområde</h3>
        ...
        <p>
          ...
          har åpnet for slike aktiviteter. Sjekk med bookingsansvarlig, eller i kalenderen nederst på nettsiden, hvilket
          tema som er satt for det aktuelle tidsrommet før påmelding og avreise, og respekter dette.
        </p>

        <Divider />
        <h3 className={classes.ruleHeader}>Reservasjon av enkeltplasser</h3>
        ...
        <Divider />
        <h3 className={classes.ruleHeader}>Eksterne gjester</h3>
        ...
        <Divider />
        <h3 className={classes.ruleHeader}>Utvask</h3>
        ...
        <Divider />
        <h3 className={classes.ruleHeader}>Etikette</h3>
        ...
        <p>
          ...
          lys i rom som ikke er i bruk, påse at panelovner er satt til 13 ᵒC, og slå av badstuen når den ikke er i bruk.
        </p>
        ...
        <Divider />
        <h3 className={classes.ruleHeader}>Sanksjoner</h3>

        <p>§7.1 Ved ødeleggelse eller brudd på reglementet har Hyttestyret full sanksjonsrett.</p>

        <p>
          §7.2 Ved tap av nøkkel faktureres nøkkelansvarlig et gebyr direkte. Hvorvidt resterende gjester skal bidra til
          å dekke gebyret eller ikke, tar ikke Hyttestyret stilling til. Ved tap av hyttenøkkel faktureres NOK 1000.
        </p>
