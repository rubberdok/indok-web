          ...
          <Grid item container direction="column" xs={6}>
            <Grid item xs={12} md={8}>
              ...
              <TextField
                ...
                error={
                  formik.touched.bjornenInternalPrice && Boolean(formik.errors.bjornenInternalPrice)
                }
                helperText={
                  formik.touched.bjornenInternalPrice && formik.errors.bjornenInternalPrice
                }
                InputLabelProps={{
              ...
              <TextField
                ...
                error={
                  formik.touched.bjornenExternalPrice && Boolean(formik.errors.bjornenExternalPrice)
                }
                helperText={
                  formik.touched.bjornenExternalPrice && formik.errors.bjornenExternalPrice
                }
                InputLabelProps={{
          ...
          <Grid item container direction="column" xs={6}>
            <Grid item xs={12} md={8}>
              ...
              <TextField
                ...
                error={
                  formik.touched.oksenInternalPrice && Boolean(formik.errors.oksenInternalPrice)
                }
              ...
              <TextField
                ...
                error={
                  formik.touched.oksenExternalPrice && Boolean(formik.errors.oksenExternalPrice)
                }
