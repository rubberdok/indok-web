...
export type EventsPageQuery = { __typename?: 'Query', events: { __typename?: 'EventsResponse', nextWeek: Array<{ __typename?: 'Event', id: string, name: string, description: string, startAt: string, endAt: string, signUpsEnabled: boolean, signUpAvailability: SignUpAvailability, categories: Array<{ __typename?: 'EventCategory', id: string, name: string }> | null }>, thisWeek: Array<{ __typename?: 'Event', id: string, name: string, description: string, startAt: string, endAt: string, signUpsEnabled: boolean, signUpAvailability: SignUpAvailability, categories: Array<{ __typename?: 'EventCategory', id: string, name: string }> | null }>, twoWeeksOrLater: Array<{ __typename?: 'Event', id: string, name: string, description: string, startAt: string, endAt: string, signUpsEnabled: boolean, signUpAvailability: SignUpAvailability, categories: Array<{ __typename?: 'EventCategory', id: string, name: string }> | null }> }, user: { __typename?: 'UserResponse', user: { __typename?: 'PrivateUser', id: string, gradeYear: number | null } | null } };

export type EventFragmentFragment = { __typename?: 'Event', id: string, name: string, description: string, startAt: string, endAt: string, signUpsEnabled: boolean, signUpAvailability: SignUpAvailability, categories: Array<{ __typename?: 'EventCategory', id: string, name: string }> | null };
