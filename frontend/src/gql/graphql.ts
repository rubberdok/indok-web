...
export type AdminBookingType = {
  ...
  externalStudentParticipants: Scalars["Int"]["output"];
...
export type BookingInput = {
  ...
  externalStudentParticipants: InputMaybe<Scalars["Int"]["input"]>;
...
export type UpdateCabinInput = {
  ...
  externalStudentPrice: InputMaybe<Scalars["Int"]["input"]>;
  externalStudentPriceWeekend: InputMaybe<Scalars["Int"]["input"]>;
  id: InputMaybe<Scalars["ID"]["input"]>;
...
export const UserWithIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "UserWithId" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<UserWithIdQuery, UserWithIdQueryVariables>;
...
export const CabinPermissionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CabinPermission" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "permission" },
                value: { kind: "StringValue", value: "cabins.manage_booking", block: false },
              },
            ],
          },
        ],
...
} as unknown as DocumentNode<CabinPermissionQuery, CabinPermissionQueryVariables>;
