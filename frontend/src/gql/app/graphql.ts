...
export type DocumentsPage_DocumentsQuery = { __typename?: 'Query', documents: { __typename?: 'DocumentsResponse', documents: Array<(
      { __typename?: 'Document', id: string }
      & { ' $fragmentRefs'?: { 'DocumentFragmentFragment': DocumentFragmentFragment } }
    )> } };

export type DocumentsAdmin_PageQueryVariables = Exact<{ [key: string]: never; }>;


export type DocumentsAdmin_PageQuery = { __typename?: 'Query', documents: { __typename?: 'DocumentsResponse', documents: Array<(
      { __typename?: 'Document', id: string, name: string, createdAt: string, updatedAt: string, description: string, file: { __typename?: 'RemoteFile', id: string, url?: string | null, name: string }, categories: Array<{ __typename?: 'DocumentCategory', id: string, name: string }> }
      & { ' $fragmentRefs'?: { 'DocumentListItemFragmentFragment': DocumentListItemFragmentFragment } }
    )> } };

export type DocumentsAdminPage_DeleteDocumentMutationVariables = Exact<{
  data: DeleteDocumentInput;
}>;


export type DocumentsAdminPage_DeleteDocumentMutation = { __typename?: 'Mutation', deleteDocument: { __typename?: 'DeleteDocumentResponse', document: { __typename?: 'Document', id: string } } };

export type DocumentListItemFragmentFragment = { __typename?: 'Document', id: string, name: string, updatedAt: string, file: { __typename?: 'RemoteFile', id: string, url?: string | null } } & { ' $fragmentName'?: 'DocumentListItemFragmentFragment' };

export type EditDocumentsPage_DocumentQueryVariables = Exact<{
  data: DocumentInput;
}>;


export type EditDocumentsPage_DocumentQuery = { __typename?: 'Query', document: { __typename?: 'DocumentResponse', document?: (
      { __typename?: 'Document', id: string, name: string, description: string, categories: Array<{ __typename?: 'DocumentCategory', id: string, name: string }> }
      & { ' $fragmentRefs'?: { 'DocumentFragmentFragment': DocumentFragmentFragment } }
    ) | null }, documentCategories: { __typename?: 'DocumentCategoryResponse', categories: Array<{ __typename?: 'DocumentCategory', id: string, name: string }> } };

export type EditDocumentsPage_UpdateDocumentMutationVariables = Exact<{
  data: UpdateDocumentInput;
}>;


export type EditDocumentsPage_UpdateDocumentMutation = { __typename?: 'Mutation', updateDocument: { __typename?: 'UpdateDocumentResponse', document: { __typename?: 'Document', id: string, name: string } } };

export type DocumentsNew_LayoutQueryVariables = Exact<{ [key: string]: never; }>;


export type DocumentsNew_LayoutQuery = { __typename?: 'Query', hasFeaturePermission: { __typename?: 'HasFeaturePermissionResponse', id: FeaturePermission, hasFeaturePermission: boolean } };

export type NewDocumentsPage_DocumentCategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type NewDocumentsPage_DocumentCategoriesQuery = { __typename?: 'Query', documentCategories: { __typename?: 'DocumentCategoryResponse', categories: Array<{ __typename?: 'DocumentCategory', id: string, name: string }> } };
...
export type NewDocumentPage_CreateDocumentMutation = { __typename?: 'Mutation', createDocument: { __typename?: 'CreateDocumentResponse', uploadUrl: string, document: (
      { __typename?: 'Document' }
      & { ' $fragmentRefs'?: { 'DocumentFragmentFragment': DocumentFragmentFragment } }
    ) } };

export type DocumentFragmentFragment = { __typename?: 'Document', name: string, description: string, file: { __typename?: 'RemoteFile', id: string, url?: string | null }, categories: Array<{ __typename?: 'DocumentCategory', id: string, name: string }> } & { ' $fragmentName'?: 'DocumentFragmentFragment' };
...
export type EventListItem_EventFragment = { __typename?: 'Event', id: string, name: string, description: string, startAt: string, signUpAvailability: SignUpAvailability, shortDescription: string, signUpDetails?: { __typename?: 'EventSignUpDetails', signUpsStartAt: string } | null, organization?: { __typename?: 'Organization', id: string, colorScheme?: string | null } | null } & { ' $fragmentName'?: 'EventListItem_EventFragment' };
...
export type OrganizationPageLayoutQuery = { __typename?: 'Query', organization: { __typename?: 'OrganizationReseponse', organization: { __typename?: 'Organization', id: string, name: string, colorScheme?: string | null, logo?: { __typename?: 'RemoteFile', id: string, url?: string | null } | null } } };
...
export type OrganizationsAdminMembersPage_UpdateRoleMutationVariables = Exact<{
  data: UpdateRoleInput;
}>;


export type OrganizationsAdminMembersPage_UpdateRoleMutation = { __typename?: 'Mutation', updateRole: { __typename?: 'UpdateRoleResponse', member: { __typename?: 'Member', id: string, role: Role, user: { __typename?: 'PublicUser', id: string, firstName: string, lastName: string } } } };
...
export type OrganizationsAdminMembersPage_RemoveMemberMutation = { __typename?: 'Mutation', removeMember: { __typename?: 'RemoveMemberResponse', member: { __typename?: 'Member', id: string, user: { __typename?: 'PublicUser', id: string, firstName: string, lastName: string } } } };

export type OrganizationsAdminEditPage_OrganizationFragmentFragment = { __typename?: 'Organization', id: string, colorScheme?: string | null, name: string, description: string, featurePermissions: Array<FeaturePermission>, logo?: { __typename?: 'RemoteFile', url?: string | null, id: string } | null } & { ' $fragmentName'?: 'OrganizationsAdminEditPage_OrganizationFragmentFragment' };
...
export type OrganizationsAdminEditPage_IsSuperUserQuery = { __typename?: 'Query', user: { __typename?: 'UserResponse', user?: { __typename?: 'PrivateUser', id: string, isSuperUser: boolean } | null }, organization: { __typename?: 'OrganizationReseponse', organization: (
      { __typename?: 'Organization' }
      & { ' $fragmentRefs'?: { 'OrganizationsAdminEditPage_OrganizationFragmentFragment': OrganizationsAdminEditPage_OrganizationFragmentFragment } }
    ) } };
...
export type OrganizationsAdminEditPageMutation = { __typename?: 'Mutation', updateOrganization: { __typename?: 'UpdateOrganizationResponse', organization: (
      { __typename?: 'Organization' }
      & { ' $fragmentRefs'?: { 'OrganizationsAdminEditPage_OrganizationFragmentFragment': OrganizationsAdminEditPage_OrganizationFragmentFragment } }
    ) } };
...
export type AppProfileUserQuery = (
  { __typename?: 'Query', user: { __typename?: 'UserResponse', user?: { __typename?: 'PrivateUser', id: string, firstName: string, lastName: string, gradeYear?: number | null, isSuperUser: boolean, studyProgram?: { __typename?: 'StudyProgram', id: string, name: string } | null } | null } }
...
export type AppProfileDocumentsPermissionQueryVariables = Exact<{ [key: string]: never; }>;


export type AppProfileDocumentsPermissionQuery = { __typename?: 'Query', hasFeaturePermission: { __typename?: 'HasFeaturePermissionResponse', id: FeaturePermission, hasFeaturePermission: boolean } };
...
export const DocumentListItemFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DocumentListItemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Document"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"file"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<DocumentListItemFragmentFragment, unknown>;
...
export const OrganizationsAdminEditPage_OrganizationFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OrganizationsAdminEditPage_OrganizationFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Organization"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"colorScheme"}},{"kind":"Field","name":{"kind":"Name","value":"logo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"featurePermissions"}}]}}]} as unknown as DocumentNode<OrganizationsAdminEditPage_OrganizationFragmentFragment, unknown>;
...
export const DocumentsPage_DocumentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DocumentsPage_Documents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"DocumentFragment"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DocumentFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Document"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"file"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<DocumentsPage_DocumentsQuery, DocumentsPage_DocumentsQueryVariables>;
export const DocumentsAdmin_PageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DocumentsAdmin_Page"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"file"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"DocumentListItemFragment"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DocumentListItemFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Document"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"file"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<DocumentsAdmin_PageQuery, DocumentsAdmin_PageQueryVariables>;
export const DocumentsAdminPage_DeleteDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DocumentsAdminPage_DeleteDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteDocumentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteDocument"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"document"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<DocumentsAdminPage_DeleteDocumentMutation, DocumentsAdminPage_DeleteDocumentMutationVariables>;
export const EditDocumentsPage_DocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EditDocumentsPage_Document"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DocumentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"document"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"document"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"DocumentFragment"}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"documentCategories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DocumentFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Document"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"file"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<EditDocumentsPage_DocumentQuery, EditDocumentsPage_DocumentQueryVariables>;
export const EditDocumentsPage_UpdateDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"EditDocumentsPage_UpdateDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateDocumentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateDocument"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"document"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<EditDocumentsPage_UpdateDocumentMutation, EditDocumentsPage_UpdateDocumentMutationVariables>;
export const DocumentsNew_LayoutDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DocumentsNew_Layout"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasFeaturePermission"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"featurePermission"},"value":{"kind":"EnumValue","value":"ARCHIVE_WRITE_DOCUMENTS"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hasFeaturePermission"}}]}}]}}]} as unknown as DocumentNode<DocumentsNew_LayoutQuery, DocumentsNew_LayoutQueryVariables>;
export const NewDocumentsPage_DocumentCategoriesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"NewDocumentsPage_DocumentCategories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"documentCategories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<NewDocumentsPage_DocumentCategoriesQuery, NewDocumentsPage_DocumentCategoriesQueryVariables>;
export const NewDocumentPage_CreateDocumentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"NewDocumentPage_CreateDocument"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateDocumentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createDocument"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"document"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"DocumentFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"uploadUrl"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DocumentFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Document"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"file"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"categories"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<NewDocumentPage_CreateDocumentMutation, NewDocumentPage_CreateDocumentMutationVariables>;
...
export const OrganizationsAdminMembersPage_UpdateRoleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"OrganizationsAdminMembersPage_UpdateRole"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateRoleInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateRole"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"member"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]}}]} as unknown as DocumentNode<OrganizationsAdminMembersPage_UpdateRoleMutation, OrganizationsAdminMembersPage_UpdateRoleMutationVariables>;
...
export const AppProfileDocumentsPermissionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AppProfileDocumentsPermission"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasFeaturePermission"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"featurePermission"},"value":{"kind":"EnumValue","value":"ARCHIVE_WRITE_DOCUMENTS"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hasFeaturePermission"}}]}}]}}]} as unknown as DocumentNode<AppProfileDocumentsPermissionQuery, AppProfileDocumentsPermissionQueryVariables>;
