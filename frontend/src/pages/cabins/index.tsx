import { Typography, makeStyles, Box, Grid, Paper, Divider, Theme, Container } from "@material-ui/core";
                    ...
                    <Grid container alignItems="center" spacing={10}>
                      ...
                      <Grid xs={12} sm={6} item>
                        ...
                        <Typography variant="body2">
                          ...
                          Oppdal. Hyttene har flere bruksområder; alt fra strategiske samlinger og egne arrangementer
                          til sosiale, spontane venneturer. Det er en gyllen mulighet til å få en liten pause fra det
                          travle bylivet. Indøks egne hyttestyre arrangerer flere forskjellige turer i løpet av året.
                          Dette er en flott mulighet til både å bli kjent med hyttene, området rundt hyttene, og å bli
                          kjent med andre indøkere på tvers av klassetrinnene. Hyttestyret har det daglige ansvaret for
                          drift og utbedring av Indøkhyttene, organisering av utleie og felles hytteturer.
                        </Typography>
                      </Grid>
                    </Grid>
                  </Grid>
                    ...
                    <Grid container alignItems="center" spacing={10} direction="row">
                      <Grid item xs={12} sm={6}>
                        ...
                        <Typography variant="body2">
                          ...
                          generelle standarden er tilnærmet lik et vanlig bolighus. Hyttene har innlagt strøm og vann
                          samt at de også har WiFi. I første etasje finner du to bad, hvorav ett med badstue, og tre
                          soverom med tre til fire sengeplasser per rom. I andre etasje ligger stue, kjøkken og et
                          fjerde soverom med sengeplass til tre. Dette gir totalt fjorten sengeplasser på hver hytte og
                          ekstramadrasser til de resterende seks det er estimert med. Dyner og puter til alle tjue
                          ligger tilgjengelig, men laken og sengetøy må medbringes. Kjøkkenet er utstyrt med det mest
                          nødvendige av hvitevarer, i tillegg til kaffetrakter, vannkoker og vaffeljern m.m.
                          Basiskrydder og olje til steking skal også være tilgjengelig. På hyttene ligger det et bredt
                          utvalg brettspill, samt kortstokker. I stua står det anlegg med AUX-kabel.
                        </Typography>
                      </Grid>
                  ...
                  <Grid item container spacing={10} alignItems="center" direction="row">
                    ...
                    <Grid item sm={12} md={6}>
                      ...
                      <Typography variant="body2">
                        ...
                        gode med hele fem løyper som begynner ved Stølen, alt fra 15 km – 1,5 km løyper. Se Oppdal
                        Booking for mer info.
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
